...
func (api *API) deleteGPUMetricsAppsIfNeed(node *v1.Node) error {
	if node.Accelerator == v1.NVAccelerator || node.Accelerator == v1.JetsonAccelerator || node.Accelerator == v1.BitmainAccelerator {
...
func (api *API) updateCoreAppConfig(app *v1.Application, node *v1.Node, freq int) error {
	...
	params := map[string]interface{}{
		...
		"GPUStats":      node.Accelerator == v1.NVAccelerator || node.Accelerator == v1.JetsonAccelerator || node.Accelerator == v1.BitmainAccelerator,
