...
type NodeService interface {
	...
	DeleteShadow(namespace, name string) error
...
// DeleteShadow delete the node's shadow
//   params:
//     - namespace string
//     - name string: node name
func (n *nodeService) DeleteShadow(namespace, name string) error {
	return n.shadow.Delete(namespace, name)
}
