...
func (m *MockPropertyService) DeleteProperty(name string) error {
	m.ctrl.T.Helper()
...
func (mr *MockPropertyServiceMockRecorder) DeleteProperty(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteProperty", reflect.TypeOf((*MockPropertyService)(nil).DeleteProperty), name)
}
...
func (m *MockPropertyService) CountProperty(name string) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPropertyServiceMockRecorder) CountProperty(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountProperty", reflect.TypeOf((*MockPropertyService)(nil).CountProperty), name)
}
...
func (m *MockPropertyService) GetPropertyValue(name string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPropertyServiceMockRecorder) GetPropertyValue(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPropertyValue", reflect.TypeOf((*MockPropertyService)(nil).GetPropertyValue), name)
}
