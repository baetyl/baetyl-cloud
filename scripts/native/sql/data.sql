...
('baetyl-kube-init-command', 'sudo mkdir -p -m 666 /var/lib/baetyl/host /var/lib/baetyl/object /var/lib/baetyl/store /var/lib/baetyl/log /var/lib/baetyl/run && curl -sfL '{{GetProperty "init-server-address"}}/v1/init/{{.InitApplyYaml}}?token={{.Token}}' -oinit.yml && kubectl apply -f init.yml'),
('baetyl-process-init-command', 'sudo mkdir -p -m 666 /var/lib/baetyl/host /var/lib/baetyl/object /var/lib/baetyl/store /var/lib/baetyl/log /var/lib/baetyl/run && baetyl apply -f '{{GetProperty "init-server-address"}}/v1/init/baetyl-init-apply.json?token={{.Token}}' --skip-verify=true'),
